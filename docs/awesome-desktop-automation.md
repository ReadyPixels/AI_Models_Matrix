# Awesome AI Desktop Automation
 ...
 _Last updated: 2026-01-28 00:30 UTC_
...
### Bytebot 🤖
- **Description**: Open-source self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
- **Key AI Features**: Containerized Linux desktop environment, multi-application support, task automation via natural language, cloud-scale deployment support.
- **Latest Version**: v1.0.0 (2026-01)
- **Supported Platforms**: Linux (Docker), Cloud deployment (Kubernetes/Helm).
- **Status**: ✅ Active Maintenance (Open Source)
- **Sources**: https://github.com/bytebot-ai/bytebot
- **Verified**: 2026-01-28 00:30 UTC
...
- **Key AI Features**: Learns from open-ended tasks, achieves 72.6% on OSWorld benchmark, experience-augmented hierarchical planning.
- **Latest Version**: Agent S3 (2025-10-02)
...
### Windows-Use 🖥️
- **Description**: Open-source Computer-USE for Windows that bridges AI agents with Windows OS at GUI layer for tasks like opening apps, clicking buttons, typing, and executing shell commands.
- **Key AI Features**: Direct Windows GUI interaction, MCP server integration, Windows-specific automation actions.
- **Latest Version**: v1.0.0
- **Supported Platforms**: Windows (Exclusive).
- **Status**: ✅ Active Development (Open Source)
- **Sources**: https://github.com/CursorTouch/Windows-Use
- **Verified**: 2026-01-28 00:30 UTC

### Open-Interface 🖱️
- **Description**: General-purpose interface allowing LLMs to control any computer through natural language commands for mouse, keyboard, and screen interactions.
- **Key AI Features**: Cross-platform control, screenshot-based vision, multi-modal interactions, extensible action system.
- **Latest Version**: v0.5.0
- **Supported Platforms**: Windows, macOS, Linux.
- **Status**: ✅ Active Maintenance (Open Source)
- **Sources**: https://github.com/AmberSahdev/Open-Interface
- **Verified**: 2026-01-28 00:30 UTC

### Computer-Agent 💻
- **Description**: Desktop application that enables AI to control your computer via terminal, browser, mouse & keyboard using screenshots for visual understanding.
- **Key AI Features**: Multi-modal input control, screenshot-based navigation, task execution across multiple applications.
- **Latest Version**: v1.2.0
- **Supported Platforms**: Windows, macOS, Linux.
- **Status**: ✅ Active Development (Open Source)
- **Sources**: https://github.com/suitedaces/computer-agent
- **Verified**: 2026-01-28 00:30 UTC
...
- **Latest Version**: v0.1.8 CLI (2025-12-23)
...
- **Latest Version**: v0.3.0 (2025-11-05)
- **Supported Platforms**: Windows, macOS, Linux.
- **Status**: Open Source.
...
- **Latest Version**: Updated (2024-06-27)
...
- **Latest Version**: Updated (2025-03-05)
...
- **Latest Version**: v3.0.0 (2025-11-05)
- **Supported Platforms**: Windows (Exclusive).
...
- **Latest Version**: v0.46.0 (2025-02-20 00:00 UTC)
...
- **Latest Version**: Updated (2024-09-01)
- **Supported Platforms**: Windows, macOS, Linux.
- **Status**: Open Source.
...
- **Latest Version**: v1.5.8 (2025-02-28)
- **Supported Platforms**: Windows, macOS, Linux.
- **Status**: Open Source (MIT).
...
- **Latest Version**: Updated (2025-03-02)
...
- **Latest Version**: v0.4.2 pre-release (2024-10-24)
- **Supported Platforms**: Windows, macOS, Linux.
- **Status**: Open Source.
...
- **Latest Version**: v9.5.9 (2025-10-25)
...
- **Latest Version**: v0.9.54 (2023-05-24)
- **Supported Platforms**: Windows, macOS, Linux.
...
- **Query Strings**: "Computer Use agents desktop automation 2025 2026", "Bytebot AI desktop agent", "Windows-Use GitHub", "Agent S3 release"
...
| Date | Changes |
|------|---------|
| 2026-01-28 00:00 UTC | Added Bytebot, Windows-Use, Open-Interface, Computer-Agent; Updated Agent S version to S3 (2025-10-02); Updated all verification timestamps to UTC |
| 2026-01-21 00:00 UTC | Initial comprehensive update with all existing entries |
