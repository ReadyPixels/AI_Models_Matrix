...
> **Extensions available for both VS Code and JetBrains (and sometimes others like Neovim).**
...
- **Key Features**: Massive context awareness, fast completion.
...
- **Key Features**: Custom models, context providers, highly configurable.
- **Latest Version**: v1.5.29 Beta (Jan 8, 2026)
...
- **Latest Version**: v0.124.0 VS Code (Nov 2025), v0.22.0 Visual Studio (Nov 25, 2025)
...
### Tabnine 🤖
- **Description**: Private, secure AI code completion.
- **Key Features**: Local model execution, high privacy.
- **Latest Version**: v3.332.0 (Dec 2, 2025)
...
### Blackbox AI 📦
- **Description**: AI coding assistant with autocomplete and chat.
- **Key Features**: Code search, fast completion.
- **Latest Version**: v2.8.44 (Late 2025)
- **Support**: VS Code.
...
- **Key Features**: Chat, diff view, templates.
- **Latest Version**: v1.6.5 (Late 2025)
...
### Mutable.ai 🔮
- **Description**: AI for production-quality code generation.
- **Key Features**: Auto-refactor, test generation.
- **Latest Version**: v3.1.4 (Late 2025)
...
- **Key Features**: AWS service integration, security scanning, cloud optimization.
- **Latest Version**: v1.19.2 (Jan 2026)
- **Support**: VS Code, JetBrains.
...
- **Key Features**: Magic commands (`%%ai`), notebook generation, model switching.
- **Latest Version**: v2.31.7
- **Support**: JupyterLab.
- **Pricing**: Free (Open Source).
- **Status**: ✅ Active Maintenance
- **Verified**: 2026-01-12
...
> **Extensions built specifically for Visual Studio Code.**
...
- **Key Features**: Deep context understanding, multi-step reasoning.
- **Latest Version**: v3.38.3 (Jan 3, 2026)
- **Support**: VS Code.
...
### Keploy 🧪
- **Description**: AI-generated test cases and mocks.
- **Key Features**: Zero-code testing, regression testing.
- **Latest Version**: v0.1.0 Alpha (Active Dev 2025)
- **Support**: VS Code, CLI.
...
> **Extensions built specifically for IntelliJ, PyCharm, etc.**

### JetBrains AI Assistant 🧠
- **Description**: Integrated AI for JetBrains IDEs.
- **Key Features**: Deep IDE integration, **Claude Agent** (native Jan 2026), refactoring, chat, multimodal prompts.
- **Latest Version**: v2025.3.x (Updated Jan 14, 2026)
...
## New Add-ons (2025-2026) 🚀

### Agent S3 Extension 🤖
- **Description**: VS Code extension for high-performance autonomous agent
...
- **Description**: VS Code extension for web automation with LLMs
