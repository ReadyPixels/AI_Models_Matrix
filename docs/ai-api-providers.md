...
_Last updated: 2025-12-20 18:00 UTC_
...
| **Cohere** | Enterprise RAG specialists | [cohere.com](https://cohere.com) | Command-R+, Rerank v3 | Pay-per-token |
...
| Provider | Description | Website | Key Features | Pricing |
|----------|-------------|---------|--------------|---------|
| **OpenRouter** | The widest model selection | [openrouter.ai](https://openrouter.ai) | 200+ models, crypto/fiat, rankings | Aggregated |
| **Hugging Face** | Community Hub Inference | [huggingface.co](https://huggingface.co/inference-api) | Access any OSS model, serverless | Free / Pro |
...
| Provider | Description | Website | Key Features | Pricing |
|----------|-------------|---------|--------------|---------|
| **Together AI** | Fast inference cloud | [together.ai](https://together.ai) | Llama/Qwen/Mistral tuned stacks | Pay-per-token |
| **Fireworks AI** | Low-latency specialist | [fireworks.ai](https://fireworks.ai) | FireAttention engine, fine-tuning | Pay-per-token |
| **Groq** | LPU Hardware (Wait for it...) | [groq.com](https://groq.com) | Instant output (>500 T/s) | Pay-per-token |
| **Cerebras** | Wafer-Scale Engine | [cerebras.ai](https://cerebras.ai) | Massive throughput (2000 T/s) | Custom |
| **Anyscale** | Ray creators | [anyscale.com](https://anyscale.com) | Scalable production endpoints | Pay-per-token |
| **Modal** | Serverless Python | [modal.com](https://modal.com) | Define infra in code, auto-scale | Pay-per-compute |
...
| Provider | Description | Website | Key Features | Pricing |
|----------|-------------|---------|--------------|---------|
| **Vultr** | Global Cloud | [vultr.com](https://vultr.com) | 32 locations, H100s | Hourly |
| **Nebius** | AI-Centric Cloud | [nebius.com](https://nebius.com) | NVIDIA H200/Blackwell | Competitive |
| **Snova** | AI Cloud | [novita.ai](https://novita.ai) | 100+ models, cheap inference | Pay-as-you-go |
| **Hyperbolic** | Decentralized Network | [hyperbolic.xyz](https://hyperbolic.xyz) | Verifiable AI, shared GPUs | Crypto/Fiat |
| **RunPod** | GPU Rental | [runpod.io](https://runpod.io) | Community cloud, wide GPU selection| Hourly |
| **Replicate** | Model-as-a-Service | [replicate.com](https://replicate.com) | Run anything via API | Pay-per-sec |
