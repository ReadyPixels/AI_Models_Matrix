...
- 🕒 **Verified**: 2025-11-26 20:50 UTC

### VSCodium 🧪
- 📝 **Description**: Community-driven, freely-licensed binaries of VS Code without telemetry or MS branding.
...
- 🔗 **Sources**: https://vscodium.com/, https://github.com/VSCodium/vscodium, https://github.com/VSCodium/vscodium/releases
- 🕒 **Verified**: 2025-11-26 20:50 UTC

### OpenVSCode Server 🌐
- 📝 **Description**: Upstream VS Code running as a server, accessible via a web browser; backed by Gitpod.
...
- 🔗 **Sources**: https://github.com/gitpod-io/openvscode-server, https://github.com/gitpod-io/openvscode-server/releases
- 🕒 **Verified**: 2025-11-26 20:50 UTC

### code-server (Coder) 🖥️
- 📝 **Description**: VS Code in the browser; run on any machine and access via web.
...
- 🔗 **Sources**: https://github.com/coder/code-server, https://github.com/coder/code-server/releases
- 🕒 **Verified**: 2025-11-26 20:50 UTC

> See add-ons and editor plugins in `docs/awesome-ai-addons.md`.
