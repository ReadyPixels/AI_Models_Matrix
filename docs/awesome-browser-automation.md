# Awesome Browser Automation
 ...
 _Last updated: 2026-01-10 08:21 UTC_
...
## New Browser Automation Tools (2025-2026) 🚀

### Agent S3 Browser Extension 🤖
- **Description**: Browser extension for high-performance autonomous agent with 72.6% OSWorld score
...
- **Status**: ✅ Active Development
- **Verified**: 2026-01-10
- **Sources**: https://github.com/agent-s3/agent-s3-browser

### LaVague Browser Extension 🌊
- **Description**: Browser extension for web automation with LLMs
...
- **Status**: ✅ Active Development
- **Verified**: 2026-01-10
- **Sources**: https://github.com/lavague-ai/LaVague-browser
